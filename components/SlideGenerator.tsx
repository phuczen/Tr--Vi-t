        ...
        try {
            ...
            if (file) {
             ...
             const prompt = `
                ...
                **LaTeX for Math**: If the topic involves math or science, use LaTeX for formulas (e.g., \`$E=mc^2$\`).

                **CRITICAL OUTPUT FORMAT:**
                Your entire response MUST be a single, valid JSON object.
                This object MUST have two keys:
                1.  \`markdownContent\`: The presentation formatted with Markdown and LaTeX for web display.
                2.  \`wordContent\`: The same presentation, but with LaTeX converted to Microsoft Word's native Equation format (UnicodeMath) for direct copy-pasting.
            `;
            ...
            let errorMsg = "Sorry, an error occurred while generating the slides. Please try again.";
            ...
            {/* Output Section */}
             <div className="lg:col-span-2 bg-white/80 backdrop-blur-sm border border-slate-200 shadow-sm p-2 rounded-2xl min-h-[600px]">
                {isLoading ? (
                    ...
                    <div className="h-full overflow-y-auto bg-white rounded-lg custom-scrollbar shadow-inner">
