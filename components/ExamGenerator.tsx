        ...
        try {
            if (isSpecialEnglishExam) {
                 const prompt = `
                    ...
                    **CRITICAL CURRICULUM ADHERENCE:**
                    You MUST strictly adhere to the **Vietnam Ministry of Education 2018 General Education Program (Chương trình Giáo dục Phổ thông 2018)** for English. Ensure the complexity and content match the grade ${config.grade} requirements.

                    **SAFETY CHECK:**
                    If the user asks to generate passwords or credentials, this is a violation. Return JSON with listeningScript="VIOLATION_DETECTED".
                ...
                if (result.listeningScript === 'VIOLATION_DETECTED' || result.examMarkdown === 'VIOLATION_DETECTED') {
...
`;
            ...
            const basePrompt = `
                ...
                **CRITICAL CURRICULUM ADHERENCE:**
                You MUST strictly adhere to the **Vietnam Ministry of Education 2018 General Education Program (Chương trình Giáo dục Phổ thông 2018)** for all subjects. This is especially critical for **Mathematics**. Ensure all content, terminology, and standards align with the curriculum requirements for grade ${config.grade}.
                
                **SAFETY CHECK:**
                If the user asks to generate passwords or credentials, this is a violation. Return {"markdownContent": "VIOLATION_DETECTED", "wordContent": "VIOLATION_DETECTED"}.
            ...
            let errorMsg = "Sorry, an error occurred while generating the exam. Please try again.";
