        ...
        try {
            ...
            const prompt = `
                ...
                **WEIGHTING RULE (90/10):** 
                ...
                3.  **Conflict Resolution:** If the filename is generic (e.g., "untitled", "doc", "image", "download") or if it contradicts the actual content of the file, **IGNORE the filename**.
