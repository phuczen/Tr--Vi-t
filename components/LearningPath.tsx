    ...
    const generateLesson = async (topic: string) => {
        const prompt = `
            ...
            **CRITICAL OUTPUT FORMAT:**
            ...
            1.  \`markdownContent\`: The lesson formatted with Markdown and LaTeX for web display. Include image placeholders like \`[IMAGE: a descriptive prompt in English]\`.
            ...
            **Lesson Structure for \`markdownContent\`:**
            ...
            -   **Visual Aids:** Insert 1-2 image placeholders: \`[IMAGE: A concise prompt in English describing the visual for image generation.]\`.
